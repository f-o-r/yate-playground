...
yate.AST.js = new pt.Codegen( 'js', fs.readFileSync(__dirname + '/../templates/js.tmpl', 'utf-8' ));
yate.AST.yate = new pt.Codegen( 'yate', fs.readFileSync(__dirname + '/../templates/yate.tmpl', 'utf-8' ));
