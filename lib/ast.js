...
yate.AST.js = new pt.Codegen( 'js', null, fs.readFileSync(__dirname + '/../templates/js.tmpl').toString());
yate.AST.yate = new pt.Codegen( 'yate', null,  fs.readFileSync(__dirname + '/../templates/yate.tmpl').toString());
